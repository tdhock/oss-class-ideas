...
- [[https://github.com/tdhock/directlabels/issues/16][fix directlabels issue#16]]: non-syntactic aes names.
...
- For somebody interested in cluster computing. Currently
  ...
  - Otherwise you can just use [[https://bitbucket.org/mugqic/genpipes][GenPipes]] which is a python library that
